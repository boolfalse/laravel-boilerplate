                    ...
                    <div class="col-md-12 scrollbox-md" data-simplebar>
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                <tr>
                                    <td scope="row"><img src="{{ asset('dashboard/assets/img/profile/profile-07.jpg') }}" class="rounded-circle mr-2" width="30" alt=""> <a href="javascript:;">John Doe</a></td>
                                    <td class="text-right">$2,546</td>
                                    <td class="text-right">$14,587</td>
                                </tr>
                                <tr>
                                    <td scope="row"><img src="{{ asset('dashboard/assets/img/profile/profile-02.jpg') }}" class="rounded-circle mr-2" width="30" alt=""> <a href="javascript:;">John Doe</a></td>
                                    <td class="text-right">$2,338</td>
                                    <td class="text-right">$8,321</td>
                                </tr>
                                <tr>
                                    <td scope="row"><img src="{{ asset('dashboard/assets/img/profile/profile-03.jpg') }}" class="rounded-circle mr-2" width="30" alt=""> <a href="javascript:;">John Doe</a></td>
                                    <td class="text-right">$1,478</td>
                                    <td class="text-right">$6,720</td>
                                </tr>
                                <tr>
                                    <td scope="row"><img src="{{ asset('dashboard/assets/img/profile/profile-04.jpg') }}" class="rounded-circle mr-2" width="30" alt=""> <a href="javascript:;">John Doe</a></td>
                                    <td class="text-right">$2,338</td>
                                    <td class="text-right">$8,321</td>
                                </tr>
                                <tr>
                                    <td scope="row"><img src="{{ asset('dashboard/assets/img/profile/profile-06.jpg') }}" class="rounded-circle mr-2" width="30" alt=""> <a href="javascript:;">John Doe</a></td>
                                    <td class="text-right">$1,478</td>
                                    <td class="text-right">$6,720</td>
                                </tr>
                                <tr>
                                    <td scope="row"><img src="{{ asset('dashboard/assets/img/profile/profile-01.jpg') }}" class="rounded-circle mr-2" width="30" alt=""> <a href="javascript:;">John Doe</a></td>
                                    <td class="text-right">$1,338</td>
                                    <td class="text-right">$4,321</td>
                                </tr>
                                <tr>
                                    <td scope="row"><img src="{{ asset('dashboard/assets/img/profile/profile-05.jpg') }}" class="rounded-circle mr-2" width="30" alt=""> <a href="javascript:;">John Doe</a></td>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card">
                            <img src="{{ asset('dashboard/assets/img/profile/profile-01.jpg') }}" alt="" class="card-img-top">
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card">
                            <img src="{{ asset('dashboard/assets/img/profile/profile-02.jpg') }}" alt="" class="card-img-top">
                            <div class="card-body p-2 text-center">
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card">
                            <img src="{{ asset('dashboard/assets/img/profile/profile-03.jpg') }}" alt="" class="card-img-top">
                            <div class="card-body p-2 text-center">
