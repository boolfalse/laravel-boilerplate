        ...
        <div class="card">
            <div class="card-header uppercase">
                <div class="caption text-primary">
                    <i class="ti-briefcase"></i> Themify Icons
                </div>
            </div>
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                    <p>Themify Icons is a complete set of icons for use in web design and apps, consisting of 320+
                        pixel-perfect, hand-crafted icons that draw inspiration from Apple iOS 7 - available to the public, 100%
                        FREE! You may use or distribute it for any purpose, whether personal or commercial. This icon set is a
                        must have tool for web designers and developers.</p>
                    <p>Check out Themify Icons at <a href="https://themify.me/themify-icons"
                                                     target="_blank">https://themify.me/themify-icons</a></p>
                </li>
            </ul>
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="webfont col-md-3 col-sm-4">
