...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card card-info mb-3">
            <div class="card-body">
                <p class="card-text">To edit in balloon mode, just highlight the text or select an element to trigger the popup toolbar.</p>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="card mb-3">
            <div class="card-header">
                <div class="caption">
                    <i class="ti-pencil-alt"></i> Balloon Editor Embeded Video
                </div>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-6">
        <div class="card mb-3">
            <div class="card-header">
                <div class="caption">
                    <i class="ti-pencil-alt"></i> Balloon Editor with Images
                </div>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-12">
        <div class="card mb-3">
            <div class="card-header">
                <div class="caption">
                    <i class="ti-pencil-alt"></i> Balloon Editor Large
                </div>
            </div>
            <div class="card-body">
