<div class="header">
    <div class="header-bar">
        <div class="brand">
            <a href="{{ route('admin.index') }}" class="logo"><span class="text-carolina">Future</span>Systems</a>
            <a href="{{ route('admin.index') }}" class="logo-sm text-carolina" style="display: none;">FS</a>
        </div>
            ...
            <div class="navbar-menu d-flex">
                ...
                <div class="menu-item">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-message">
                        ...
                        <li>
                            <img src="{{ asset('dashboard/assets/img/profile/profile-04.jpg') }}">
                            <div class="message-row">
                                <small>24h ago</small>
                                <a href="#"><span class="message-user">John Doe</span><br>
                                    Staff meeting on Tuesday at 4PM, remember to set date</a>
                            </div>
                        </li>
                        <li>
                            <img src="{{ asset('dashboard/assets/img/profile/profile-07.jpg') }}">
                            <div class="message-row">
                                <small>2h ago</small>
                                <a href="#"><span class="message-user">John Doe</span><br>
                        ...
                        <li>
                            <img src="{{ asset('dashboard/assets/img/profile/profile-06.jpg') }}">
                            <div class="message-row">
                                <small>3d ago</small>
                                <a href="#"><span class="message-user">John Doe</span><br>
