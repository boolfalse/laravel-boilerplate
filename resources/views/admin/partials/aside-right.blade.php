        ...
        <div class="tab-content">
            ...
            <div id="tab-1" class="tab-pane show active">
                <div class="pane-header">
                    ...
                    <i class="fa fa-circle text-success"></i> <span class="profile-user">John Doe</span>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="message-group d-flex flex-row mb-3">
                                    <a href="#"><img src="{{ asset('dashboard/assets/img/profile/profile-01.jpg') }}" class="rounded"
                                                     alt="image"></a>
                                ...
                                <div class="message-group d-flex flex-row mb-3">
                                    <a href="#"><img src="{{ asset('dashboard/assets/img/profile/profile-03.jpg') }}" class="rounded"
                                                     alt="image"></a>
                                    <div class="message-item">
                                ...
                                <div class="message-group d-flex flex-row mb-3">
                                    <a href="#"><img src="{{ asset('dashboard/assets/img/profile/profile-02.jpg') }}" class="rounded"
                                                     alt="image"></a>
                                    <div class="message-item">
                                ...
                                <div class="message-group d-flex flex-row">
                                    <a href="#"><img src="{{ asset('dashboard/assets/img/profile/profile-05.jpg') }}" class="rounded"
                                                     alt="image"></a>
                                    <div class="message-item">
